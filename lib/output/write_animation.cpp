...
static WordSequence failSeq = {{0, 0x20}, {0, 0x30}, {0, 0x31}, {0, 0x71}, {1, 0x20}, {1, 0x30},
    {1, 0x31}, {1, 0x33}, {1, 0x37}, {1, 0x77}, {2, 0x02}, {2, 0x06}, {3, 0x20}, {3, 0x30},
    {3, 0x38}
};

static WordSequence firstSeq = {{0, 0x00}, {1, 0x20}, {1, 0x30}, {2, 0x01}, {2, 0x21}, {2, 0x61},
    {2, 0x65}, {2, 0x6d}, {3, 0x40}, {3, 0x60}, {3, 0x70}, {3, 0x78}, {3, 0xf8}
};

static WordSequence secondSeq = {{0, 0x00}, {1, 0x01}, {1, 0x03}, {1, 0x43}, {1, 0x53}, {1, 0x5b},
    {2, 0x10}, {2, 0x50}, {2, 0x54}, {3, 0x40}, {3, 0x50}, {3, 0x58}, {3, 0x5a}, {3, 0x5e},
    {3, 0xde}
};

static WordSequence thirdSeq = {{0, 0x00}, {1, 0x01}, {1, 0x03}, {1, 0x43}, {1, 0x47}, {1, 0x4f},
